                    ...
                    <form id="formulaire-saisie-inscription" class="needs-validation" novalidate>
                        ...
                        <div class="row g-3 col-md-5">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="firstName" placeholder="1234" value="" required minlength="8" maxlength="20">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="text" class="form-control" id="username" placeholder="Username" required maxlength="20">
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" class="form-control" id="email" placeholder="utilisateur@example.com">
                                <div class="invalid-feedback">
